...
with tf.Session() as sess:
    ...
    for b in range(0,10000,500):
        ok += tf.reduce_sum(tf.cast(correct_pred.eval(feed_dict={x: mnist.test.images[b:b+499].reshape((-1, n_steps, n_input)), y: mnist.test.labels[b:b+499]}),tf.float32)).eval()
